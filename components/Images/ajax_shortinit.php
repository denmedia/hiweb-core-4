...
ImagesFactory::$usePictureHtmlTag = (bool)$_POST['usePictureHtml'];
ImagesFactory::$useWidthHeightProps = (bool)$_POST['useWidthHeightProps'];
$images = [];
$images_urls = [];
$images_error = [];
...
foreach ($_POST['images'] as $defer_id => $defer_data) {
    ...
    ///is webp support
    $images[$defer_id] = HTML_CSS_JS_Minifier::minify_html($image->get_html($defer_data['dimension'], isset($defer_data['attributes']) ? $defer_data['attributes'] : [], null, get_client()->is_support_WebP()));
