...
b(document).on("ajaxComplete",function(){2===a.is_receive_data?a.is_receive_data=0:0===a.is_receive_data&&a.receive_images_data(a.find_images_on_windows)}))},100)},receive_images_data:function(d){a.is_receive_data=1;var c=b("[data-image-defer-id]");0!==c.length&&(c.each(function(){var d=b(this);a.source_images_data[d.attr("data-image-defer-id")]=JSON.parse(d.attr("data-image-defer"))}),b.ajax({url:hiweb_imageDefer_ajax_url,type:"post",dataType:"json",data:{images:a.source_images_data},success:function(c){if(c.success){for(var e in c.images)a.receive_images_html.hasOwnProperty(e)||
(a.receive_images_html[e]=c.images[e],a.receive_images_src[e]=c.images_src[e]);"function"===typeof d&&d()}b("body").append(c.js)},complete:function(){a.is_receive_data=2}}))},make_events:function(){b(window).scroll(function(b){a.scroll_event_now||(a.scroll_event_now=!0,clearTimeout(a.scroll_event_handler),a.scroll_event_handler=setTimeout(function(){a.find_images_on_windows();a.queue_start();a.scroll_event_now=!1},a.scroll_event_interval))})},find_images_on_windows:function(){var d=b(window).scrollTop()+
window.innerHeight,c;for(c in a.receive_images_html)if(!(-1<a.images_ids_queue.indexOf(c)||-1<a.images_ids_processed.indexOf(c))){var e=b('[data-image-defer-id="'+c+'"][data-image-defer-status="preload"]'),f=0<e.find("img").length?e.find("img").offset().top:e.offset().top;0<e.length&&f<d+e.height()-100&&(a.images_ids_queue.push(c),a.queue_start())}},queue_start:function(){if(!a.queue_started){a.queue_started=!0;for(var b=0;b<a.queue_parallel_limit;b++)a.queue_next(),a.queue_parallel_count++}},queue_next:function(){if(a.queue_started||
!(a.queue_parallel_count>=a.queue_parallel_limit))if(0===a.images_ids_queue.length)a.queue_started=!1,a.queue_parallel_count=0;else{var b=a.images_ids_queue.shift();a.images_ids_processed.push(b);a.load_image(b,a.queue_next)}},load_image:function(d,c){if(a.receive_images_html.hasOwnProperty(d)){var e=b('[data-image-defer-id="'+d+'"]');if(0<e.length){e.addClass("data-image-defer-status","loading");var f=a.receive_images_src[d],g=f.length;if(0===g&&"function"===typeof c)return c();for(var k in f){var h=
new Image;h.onload=function(){g--;1>g&&"function"===typeof c&&(e.replaceWith(b(a.receive_images_html[d]).attr("data-image-defer-status","loaded")),c())};h.onerror=function(){g--;1>g&&"function"===typeof c&&c()};h.src=f[k]}}}}};a.init()}});
