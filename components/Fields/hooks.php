<?php
	...
	//ADMIN HOOKS
	//FORM LOAD
	add_action( 'wp_ajax_hiweb-components-form', '\hiweb\components\Fields\FieldsAdminFactory::get_ajax_form_hock' );
	//Post Type
	add_action( 'edit_form_top', '\hiweb\components\Fields\FieldsAdminFactory::_edit_form_top' );
	add_action( 'edit_form_before_permalink', '\hiweb\components\Fields\FieldsAdminFactory::_edit_form_before_permalink' );
	add_action( 'edit_form_after_title', '\hiweb\components\Fields\FieldsAdminFactory::_edit_form_after_title' );
	add_action( 'edit_form_after_editor', '\hiweb\components\Fields\FieldsAdminFactory::_edit_form_after_editor' );
	add_action( 'submitpost_box', '\hiweb\components\Fields\FieldsAdminFactory::_submitpost_box' );
	add_action( 'submitpage_box', '\hiweb\components\Fields\FieldsAdminFactory::_submitpost_box' );
	add_action( 'edit_form_advanced', '\hiweb\components\Fields\FieldsAdminFactory::_edit_form_advanced' );
	add_action( 'edit_page_form', '\hiweb\components\Fields\FieldsAdminFactory::_edit_page_form' );
	add_action( 'dbx_post_sidebar', '\hiweb\components\Fields\FieldsAdminFactory::_dbx_post_sidebar' );
	//Post type Meta Box
	add_action( 'add_meta_boxes', '\hiweb\components\Fields\FieldsAdminFactory::_add_meta_boxes', 8, 2 );
	///Post Save
	add_action( 'save_post', '\hiweb\components\Fields\FieldsAdminFactory::_save_post', 10, 3 );
