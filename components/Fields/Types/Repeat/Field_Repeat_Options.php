<?php
	...
	class Field_Repeat_Options extends Field_Options{
		 ...
		 * @return array
		 */
		public function get_flex_ids(): array {
		 ...
		 * @deprecated
		 */
		public function get_cols_simple( $prefix_name = '' ): array {
			$R = [];
		 ...
		 */
		public function add_col_flex_field( $flex_id, $Field_or_FieldOptions ): Field_Repeat_Col {
			$cols = $this->get_cols();
		 ...
		 * @return Field_Repeat_Col
		 */
		public function add_col_field( $Field_or_FieldOptions, $flex_id = '' ): Field_Repeat_Col {
