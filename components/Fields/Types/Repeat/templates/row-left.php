...
?>
<div class="repeat__row__left" data-drag-handle="<?= $this->field()->get_unique_id() ?>" data-click="collapse" data-unique_id="<?= $this->field()->get_unique_id() ?>" title="<?= __('click - collapse / expand; drag - sorting this row', 'hiweb-core-4') ?>">
