<?php
	...
	abstract class Options{
		...
		public function __construct( $parent_OptionsObject = null ){
			$this->options_ArrayObject = new ArrayObject( [] );
		 ...
		 * @return ArrayObject
		 */
		protected function ArrayObject(){
		...
		public function _is_exists( $option_key ){
			return $this->ArrayObject()->is_key_exists( $option_key );
		}
		...
		public function _get_optionsCollect(){
			$R = [];
			foreach( $this->ArrayObject()->get() as $key => $value ){
