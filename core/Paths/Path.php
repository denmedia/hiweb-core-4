<?php
	...
	class Path{
		...
		public function is_relative(){
			return is_string( $this->original_path ) && ( strpos( $this->original_path, Paths::get_root_path() ) !== 0 && !$this->is_url() );
		}
		...
		public function get_path_relative( $return_params = false ){
			if( $this->is_url() ){
				...
				return str_replace( Paths::root()->get_original_path(), '', $this->get_original_path() );
			}
		}
